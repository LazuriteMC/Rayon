...
public class Rayon {
	...
	public static final ComponentKey<RigidBodyEntity> PHYSICS_ENTITY = ComponentRegistryV3.INSTANCE.getOrCreate(new Identifier(MODID, "entity"), RigidBodyEntity.class);
