...
public class ClientPhysicsHandler implements PhysicsHandler {
    ...
    public ClientPhysicsHandler(PhysicsEntity entity) {
        ...
        LazuriteClient.physicsWorld.add(this);
    }

    /**
     * Gets whether the entity is active. It is active when the {@link RigidBody}
     * is in the {@link dev.lazurite.api.client.physics.PhysicsWorld}.
     * @return whether or not the entity is active
     */
    public boolean isActive() {
        return entity.age > 1 && entity.getValue(PhysicsEntity.PLAYER_ID) == LazuriteClient.client.player.getEntityId();
    }
    ...
    public void createRigidBody() {
        ...
        if (getRigidBody() != null) {
            ...
            LazuriteClient.physicsWorld.removeRigidBody(old);
        } else {
        ...
        LazuriteClient.physicsWorld.addRigidBody(body);
        this.body = body;
    }
}
