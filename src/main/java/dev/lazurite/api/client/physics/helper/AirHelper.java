...
public class AirHelper {
     ...
     */
    public static Vector3f getResistanceForce(Vector3f velocity, int size, float dragCoefficient) {
        // TODO Get size based on model shape in direction of movement (ask peyon)

        float k = (LazuriteClient.physicsWorld.getAirDensity() * dragCoefficient * (float) Math.pow(size / 16f, 2)) / 2.0f;
